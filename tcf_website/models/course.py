# pylint: disable=missing-class-docstring, fixme, line-too-long, unused-import, no-member, cyclic-import, too-many-lines
"""TCF course models.

course imports Review at end-of-file because course methods reference Review
and review.py imports Course/Instructor/Semester for its FKs. The deferred
import is intentional and works at runtime; pylint's cyclic-import is
...
# Deferred import: course methods reference Review, but review.py imports
# Course/Instructor/Semester at top-level. Keeping this at end-of-file lets
# both modules load cleanly. See models/__init__.py load order.
from .review import Review  # noqa: E402  pylint: disable=wrong-import-position
